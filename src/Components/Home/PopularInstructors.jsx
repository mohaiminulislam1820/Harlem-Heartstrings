...
const PopularInstructors = () => {
    ...
    return (
        <div className="mt-24 container">
            ...
            <p className="text-center ">Meet our amazing team of instructors who will make your violin learning experience fun and rewarding. They will tailor their lessons to your goals and preferences, and help you achieve your musical dreams.</p>
