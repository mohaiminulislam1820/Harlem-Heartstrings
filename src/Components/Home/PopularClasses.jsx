...
const PopularClasses = () => {
    ...
    return (
        <div className="mt-24 container">
            ...
            <p className="text-center"> If you are looking for some inspiration and motivation, check out our popular classes. These are the courses that our students love and recommend. Don't miss this chance to enroll in one of our popular classes and take your violin skills to the next level.</p>
